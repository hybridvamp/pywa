...
class WhatsApp(Server, _AsyncListeners, _WhatsApp):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            session: The session used for API requests (default: a new `httpx.AsyncClient() <https://www.python-httpx.org/api/#asyncclient>`_). Use a custom session to configure proxies, timeouts, etc. Do not share the same session across multiple WhatsApp clients.
    ...
    async def send_voice(
        ...
        *,
        ...
        )._convert_to(subclass=SentVoiceMessage)
    ...
    async def create_qr_code(
        ...
        *,
        ...
        return QRCode.from_dict(
            data=await self.api.create_qr_code(
                phone_id=phone_id,
    ...
    async def get_qr_code(
        ...
        """
        phone_id = helpers.resolve_arg(wa=self, value=phone_id, method_arg="phone_id", client_arg="phone_id")
        qrs = (await self.api.get_qr_code(
            phone_id=phone_id,
            code=code,
    ...
    async def update_qr_code(
        ...
        phone_id = helpers.resolve_arg(wa=self, value=phone_id, method_arg="phone_id", client_arg="phone_id")
        return QRCode.from_dict(
            data=await self.api.update_qr_code(
                phone_id=phone_id,
                code=code,
                prefilled_message=prefilled_message,
            ),
